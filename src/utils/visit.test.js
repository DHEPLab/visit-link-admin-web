...
it("should merge date and time", () => {
  expect(Visit.mergeDateAndTime(new Date("2020-07-12 11:11"), new Date("2020-07-12 18:00"))).toBe("2020-07-12T18:00");
});
...
it("should default datetime is range0", () => {
  expect(Visit.defaultDatetime(["2020-07-28", "2020-08-13"], "2020-07-26")).toBe("2020-07-28T10:00");
});
